...
export const en = {
  ...
  cursor_system: "SYSTEM DEFAULT",
  cursor_crosshair: "CROSSHAIR (TACTICAL)",
  cursor_rounded: "ROUNDED (DARK)",
  ...
  flicker_intensity: "JITTER INTENSITY",
  flicker_speed: "FLICKER RATE",
  rain_effect: "RAIN",
  tron_game: "TRON GRID",
